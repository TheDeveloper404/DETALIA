...
| [Detalia_Canvas.md](Detalia_Canvas.md) | Concept original al feature-ului Planșă (canvas privat) — parțial neactual; implementarea curentă diverge pe puncte concrete (vezi banner-ul din document). |
